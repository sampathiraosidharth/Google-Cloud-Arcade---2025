...
```bash
curl -LO https://github.com/sampathiraosidharth/Google-Cloud-Arcade---2025/raw/refs/heads/main/Level%201:%20Application%20Development%20and%20Security%20with%20GCP/Build%20and%20Automate/GSP702%20Deploy%20Go%20Apps%20on%20Google%20Cloud%20Serverless%20Platforms/702.sh
sudo chmod +x *.sh
./*.sh
```
---
